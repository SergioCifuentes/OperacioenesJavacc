/* Generated By:JavaCC: Do not edit this line. Adder.java */
  ...
  final public void Start() throws ParseException {
               Adder declaraciones; Integer resultado;
    declaraciones = Z();
    resultado = X(declaraciones);
                                                  System.ou.println("el resultado es" + resultado);
  }
  ...
  final public Integer X(Adder letras) throws ParseException {
                         Integer resT; Integer resXP;
    resT = T(letras);
    resXP = XP(letras,resT);
                                         {if (true) return resXP;}
    throw new Error("Missing return statement in function");
  }

  final public Integer XP(Adder letras, Integer resT) throws ParseException {
                                        Integer resultT,resXP;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case MAS:
      jj_consume_token(MAS);
      resultT = T(letras);
      resXP = XP(letras,resT+resultT);
                                                           {if (true) return resXP;}
      break;
    case MENOS:
  ...
  final public Integer T(Adder letras) throws ParseException {
  ...
  final public Integer TP(Integer val,Adder letras) throws ParseException {
                                      Integer numero;Integer resultado;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case MUL:
      ...
      resultado = TP(val*numero,letras);
                                                          {if (true) return resutado;}
      break;
    case DIV:
      jj_consume_token(DIV);
      numero = F(letras);
      resultado = TP(val/numero,letras);
                                                              {if (true) return restado;}
      break;
    default:
      jj_la1[1] = jj_gen;
       {if (true) return val;}
